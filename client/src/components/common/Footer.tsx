      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">APIStore</span>
            </div>
            <p className="mt-2 text-sm text-gray-400">
              Empowering developers with reliable and scalable API solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-center text-gray-400">
                ...
                <span>contact@apistore.com</span>
              </li>
              <li className="flex items-center text-gray-400">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2025 APIStore, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
